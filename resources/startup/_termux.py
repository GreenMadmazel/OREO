...
COPYRIGHT = f"©️ OREO {datetime.now().year}"
...
░ ░ ░ ▒    ░░   ░    ░   ░ ░ ░ ▒  
    ░ ░     ░        ░  ░    ░ ░  
{Style.RESET_ALL}
{Fore.GREEN}- OREO Termux Installation -
  The Main Aim of this script is to deploy OREO with basic requirements and save your phone resources.
{Fore.RESET}
...
print(f"{Fore.YELLOW}* Do you want to get OREO Logs in Colors? [Y/N] ")
...
sleep(0.2)
print(f"Use 'bash startup' to try running OreO.{Fore.RESET}")
sleep(0.5)
print(
    "\nYou can head over to @OreoSupportChat, if you get stuck somewhere, and need help."
)
sleep(0.5)
