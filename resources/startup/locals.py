...
def start():
    ...
    print(f"{a}\n\n")
    print("Welcome to OreO, lets start setting up!\n\n")
    print("Cloning the repository...\n\n")
    os.system("rm -rf OREO")
    os.system("git clone https://github.com/itzNightmare17/OREO")
    print("\n\nDone")
    os.chdir("OREO")
    clear_screen()
    print(a)
    ...
    all_done = "# OREO Environment Variables.\n# Do not delete this file.\n\n"
    for i in varrs:
        all_done += do_input(i)
    clear_screen()
    print(a)
