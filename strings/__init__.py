...
from pyOreo import *
from pyOreo.fns.tools import translate
...
OREConfig.lang = udB.get_key("language") or os.getenv("LANGUAGE", "en")
...
load(PATH.format(OREConfig.lang))


def get_string(key: str, _res: bool = True) -> Any:
    lang = OREConfig.lang or "en"
    try:
