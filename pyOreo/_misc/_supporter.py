...
from pyOreo._misc._decorators import compile_pattern, oreo_cmd
...
ALIVE_NAME = oreo_bot.me.first_name
BOTLOG_CHATID = BOTLOG = udB.get_key("LOG_CHANNEL")


bot = borg = catub = friday = oreo_bot
catub.cat_cmd = oreo_cmd
