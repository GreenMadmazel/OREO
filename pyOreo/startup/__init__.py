...
if run_as_module:
    ...
    from ..version import __version__ as __pyOreo__
    ...
    LOGS.info(f"py-Oreo Version - {__pyOreo__}")
    LOGS.info(f"Telethon Version - {__version__} [Layer: {LAYER}]")
    LOGS.info(f"Oreo Version - {oreo_version} [{HOSTED_ON}]")
